--TEST--
round 4 stock polish: integer min/max/reference accepted; diamond candle stays inside cell
--EXTENSIONS--
fastchart
--FILE--
<?php
...
?>
--EXPECT--
indicator_pane_int_opts: drawn ok
dense_diamond: drawn ok
no_right_overflow: ok
