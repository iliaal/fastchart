...
bool(true)
bool(true)
abstract: Cannot instantiate abstract class FastChart\Chart
int(0)
int(1)
bool(true)
LineChart: FastChart\LineChart
bool(true)
BarChart: FastChart\BarChart
bool(true)
PieChart: FastChart\PieChart
bool(true)
ScatterChart: FastChart\ScatterChart
bool(true)
StockChart: FastChart\StockChart
bool(true)
type: ok
bool(true)
bool(true)
