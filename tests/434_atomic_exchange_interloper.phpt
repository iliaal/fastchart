--TEST--
renderToFile exchange preserves a destination replaced after installation
--EXTENSIONS--
fastchart
--SKIPIF--
<?php
...
$dir = sys_get_temp_dir() . '/fastchart-exchange-interloper-'
...
echo 'exchange race synchronized: ', $substituted ? "yes\n" : "NO\n";
...
?>
--EXPECT--
exchange race synchronized: yes
render rejected: yes
