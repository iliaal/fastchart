--TEST--
renderToFile fallback preserves a destination replaced after link installation
--EXTENSIONS--
fastchart
--SKIPIF--
<?php
...
$dir = sys_get_temp_dir() . '/fastchart-fallback-interloper-'
...
clearstatcache(true, $target);
echo 'post-link race synchronized: ', $substituted ? "yes\n" : "NO\n";
...
?>
--EXPECT--
post-link race synchronized: yes
render rejected: yes
