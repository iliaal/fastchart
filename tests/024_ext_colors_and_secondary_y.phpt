--TEST--
Per-point ext colors (Bar, Line) + secondary Y axis (Line)
--EXTENSIONS--
fastchart
--FILE--
<?php
...
?>
--EXPECT--
bar_ext_colors_present: yes (5/5)
line_marker_ext_colors_present: yes (5/5)
bool(true)
secondary_y_left_series_present: yes
secondary_y_right_series_present: yes
