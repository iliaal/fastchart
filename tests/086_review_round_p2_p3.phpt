--TEST--
Review-round P2/P3: per-render caches, image-map typed, scatter format, dead 'label'
--EXTENSIONS--
fastchart
--FILE--
<?php
...
image_map_clone: ok
image_map_repeat: ok
image_map_undrawn: ok
image_map_scheme_filter: ok
scatter_x_format: ok
overlay_no_label: ok
trend_degree_3: ok
trend_degree_4: ValueError ok
font_cache_repeat: ok
