--TEST--
BarChart::setOrientation(BAR_HORIZONTAL) renders sideways bars
--EXTENSIONS--
fastchart
--FILE--
<?php
...
?>
--EXPECT--
single_horizontal: ok
multi_horizontal: ok
stacked_horizontal: ok
floating_horizontal: ok
negatives_horizontal: ok
default_vertical: ok
bad_orientation: ValueError ok
BAR_VERTICAL=0 BAR_HORIZONTAL=1
