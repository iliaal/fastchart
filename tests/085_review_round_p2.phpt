--TEST--
Review-round P2: allocation caps, color-cache hot path, short-write detection
--EXTENSIONS--
fastchart
--FILE--
<?php
...
?>
--EXPECT--
volume_colors_clamp: ok
explode_clamp: ok
levels_clamp: ok
category_labels_clamp: ok
outliers_clamp: ok
scatter_color_cache: ok
render_to_file_complete: ok
strict_setter: ok
