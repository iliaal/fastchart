--TEST--
Step-plot interpolation modes + addHorizontalBand shaded ranges
--EXTENSIONS--
fastchart
--FILE--
<?php
...
interp=2: ok
interp=3: ok
bad_interp: ValueError ok
bands_render: ok
swapped_bounds: ok
bad_color: ValueError ok
bad_alpha: ValueError ok
nan_low: ValueError ok
seventeenth: ValueError ok
STEP_AFTER=2 STEP_BEFORE=3
