--TEST--
setYAxisScale(SCALE_LOG): log10 ticks; rejects non-positive data
--EXTENSIONS--
fastchart
--FILE--
<?php
...
--EXPECT--
bool(true)
log_value_100_near_middle: yes
log_zero: ValueError ok
log_negative: ValueError ok
bad_scale: ValueError ok
