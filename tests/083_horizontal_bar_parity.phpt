--TEST--
Horizontal-bar parity: category-axis bands + h/v line annotations
--EXTENSIONS--
fastchart
--FILE--
<?php
...
?>
--EXPECT--
h_bar_category_band: ok
h_bar_value_line: ok
h_bar_category_line: ok
h_bar_mixed_overlays: ok
h_bar_out_of_range: ok
v_bar_unchanged: ok
