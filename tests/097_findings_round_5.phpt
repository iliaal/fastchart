...
?>
--EXPECT--
macd_huge_signal: ValueError
stoch_huge_smooth: ValueError
heatmap_grid_cap: ValueError
surface_grid_cap: ValueError
huge_dim_skipped: yes
small_dim_used:   yes
boll_range_used:  yes
funnel_format:    differs
wf_kind_strict:   ok
wf_total_works:   yes
meter_empty_clears: yes
