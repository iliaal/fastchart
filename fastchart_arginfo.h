...
static zend_class_entry *register_class_FastChart_BarChart(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_BAR_RADIAL_name = zend_string_init_interned("BAR_RADIAL", sizeof("BAR_RADIAL") - 1, true);
	...
	zend_string_release_ex(const_BAR_RADIAL_name, true);

	zval const_BAR_STYLE_BAR_value;
	ZVAL_LONG(&const_BAR_STYLE_BAR_value, 0);
	zend_string *const_BAR_STYLE_BAR_name = zend_string_init_interned("BAR_STYLE_BAR", sizeof("BAR_STYLE_BAR") - 1, true);
	...
	zend_string_release_ex(const_BAR_STYLE_BAR_name, true);

	zval const_BAR_STYLE_LOLLIPOP_value;
	ZVAL_LONG(&const_BAR_STYLE_LOLLIPOP_value, 1);
	zend_string *const_BAR_STYLE_LOLLIPOP_name = zend_string_init_interned("BAR_STYLE_LOLLIPOP", sizeof("BAR_STYLE_LOLLIPOP") - 1, true);
	...
	zend_string_release_ex(const_BAR_STYLE_LOLLIPOP_name, true);

	zval const_BAR_STYLE_DUMBBELL_value;
	ZVAL_LONG(&const_BAR_STYLE_DUMBBELL_value, 2);
	zend_string *const_BAR_STYLE_DUMBBELL_name = zend_string_init_interned("BAR_STYLE_DUMBBELL", sizeof("BAR_STYLE_DUMBBELL") - 1, true);
	...
	zend_string_release_ex(const_BAR_STYLE_DUMBBELL_name, true);
...
static zend_class_entry *register_class_FastChart_GaugeChart(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_STYLE_NEEDLE_name = zend_string_init_interned("STYLE_NEEDLE", sizeof("STYLE_NEEDLE") - 1, true);
	...
	zend_string_release_ex(const_STYLE_NEEDLE_name, true);

	zval const_STYLE_SOLID_value;
	ZVAL_LONG(&const_STYLE_SOLID_value, 1);
	zend_string *const_STYLE_SOLID_name = zend_string_init_interned("STYLE_SOLID", sizeof("STYLE_SOLID") - 1, true);
	...
	zend_string_release_ex(const_STYLE_SOLID_name, true);
...
static zend_class_entry *register_class_FastChart_ArcDiagram(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_ORIENT_UP_name = zend_string_init_interned("ORIENT_UP", sizeof("ORIENT_UP") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_UP_name, true);

	zval const_ORIENT_DOWN_value;
	ZVAL_LONG(&const_ORIENT_DOWN_value, 1);
	zend_string *const_ORIENT_DOWN_name = zend_string_init_interned("ORIENT_DOWN", sizeof("ORIENT_DOWN") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_DOWN_name, true);

	zval const_ORIENT_SPLIT_value;
	ZVAL_LONG(&const_ORIENT_SPLIT_value, 2);
	zend_string *const_ORIENT_SPLIT_name = zend_string_init_interned("ORIENT_SPLIT", sizeof("ORIENT_SPLIT") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_SPLIT_name, true);
...
static zend_class_entry *register_class_FastChart_ChordDiagram(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_STYLE_RIBBON_name = zend_string_init_interned("STYLE_RIBBON", sizeof("STYLE_RIBBON") - 1, true);
	...
	zend_string_release_ex(const_STYLE_RIBBON_name, true);
	...
	zend_string *const_STYLE_DIRECTED_name = zend_string_init_interned("STYLE_DIRECTED", sizeof("STYLE_DIRECTED") - 1, true);
	...
	zend_string_release_ex(const_STYLE_DIRECTED_name, true);
...
static zend_class_entry *register_class_FastChart_Dendrogram(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_STYLE_TREE_name = zend_string_init_interned("STYLE_TREE", sizeof("STYLE_TREE") - 1, true);
	...
	zend_string_release_ex(const_STYLE_TREE_name, true);

	zval const_STYLE_ELBOW_value;
	ZVAL_LONG(&const_STYLE_ELBOW_value, 1);
	zend_string *const_STYLE_ELBOW_name = zend_string_init_interned("STYLE_ELBOW", sizeof("STYLE_ELBOW") - 1, true);
	...
	zend_string_release_ex(const_STYLE_ELBOW_name, true);

	zval const_ORIENT_TOP_value;
	ZVAL_LONG(&const_ORIENT_TOP_value, 0);
	zend_string *const_ORIENT_TOP_name = zend_string_init_interned("ORIENT_TOP", sizeof("ORIENT_TOP") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_TOP_name, true);

	zval const_ORIENT_LEFT_value;
	ZVAL_LONG(&const_ORIENT_LEFT_value, 1);
	zend_string *const_ORIENT_LEFT_name = zend_string_init_interned("ORIENT_LEFT", sizeof("ORIENT_LEFT") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_LEFT_name, true);
...
static zend_class_entry *register_class_FastChart_Partition(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_ORIENT_HORIZONTAL_name = zend_string_init_interned("ORIENT_HORIZONTAL", sizeof("ORIENT_HORIZONTAL") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_HORIZONTAL_name, true);

	zval const_ORIENT_VERTICAL_value;
	ZVAL_LONG(&const_ORIENT_VERTICAL_value, 1);
	zend_string *const_ORIENT_VERTICAL_name = zend_string_init_interned("ORIENT_VERTICAL", sizeof("ORIENT_VERTICAL") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_VERTICAL_name, true);
...
static zend_class_entry *register_class_FastChart_Pictogram(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_SHAPE_SQUARE_name = zend_string_init_interned("SHAPE_SQUARE", sizeof("SHAPE_SQUARE") - 1, true);
	...
	zend_string_release_ex(const_SHAPE_SQUARE_name, true);

	zval const_SHAPE_CIRCLE_value;
	ZVAL_LONG(&const_SHAPE_CIRCLE_value, 1);
	zend_string *const_SHAPE_CIRCLE_name = zend_string_init_interned("SHAPE_CIRCLE", sizeof("SHAPE_CIRCLE") - 1, true);
	...
	zend_string_release_ex(const_SHAPE_CIRCLE_name, true);

	zval const_SHAPE_PERSON_value;
	ZVAL_LONG(&const_SHAPE_PERSON_value, 2);
	zend_string *const_SHAPE_PERSON_name = zend_string_init_interned("SHAPE_PERSON", sizeof("SHAPE_PERSON") - 1, true);
	...
	zend_string_release_ex(const_SHAPE_PERSON_name, true);
...
static zend_class_entry *register_class_FastChart_WordCloud(zend_class_entry *class_entry_FastChart_Chart)
{
	...
	zend_string *const_ORIENT_MIXED_name = zend_string_init_interned("ORIENT_MIXED", sizeof("ORIENT_MIXED") - 1, true);
	...
	zend_string_release_ex(const_ORIENT_MIXED_name, true);
